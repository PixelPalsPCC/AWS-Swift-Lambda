...
func handle(_ event: Request, context: LambdaContext) async throws -> Response {
    ...
    guard let bucketName = "badboatstacjbucket" else {
    ...
    do {
        ...
        responseMessage =
            "The Lambda function encountered an error and your data was not saved. Root cause: \(error.errorCode ?? "") - \(error.message ?? "")"
